;;; config.el --- Spacemacs Layouts Layer configuration File for Spacemacs  -*- lexical-binding: nil; -*-
;;
...
set function is called which removes and adds advice to the respective
functions."
